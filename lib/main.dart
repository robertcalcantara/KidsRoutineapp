...
import 'tela_historico.dart';
import 'tela_configuracoes.dart';
import 'tela_nova_atividade.dart'; // O import da sua nova tela já está aqui!
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        // NOVA ATIVIDADE
        '/nova-atividade': (context) => const NovaAtividadeScreen(), // Rota adicionada com sucesso!
      },
    );
  }
>>>>>>> bfde009 (feat: listagem dinamica de atividades na home)
}
